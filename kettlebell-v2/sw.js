const CACHE='kb-coach-v5-1';
const ASSETS=['./','./index.html','./styles.css','./program.js','./app.js','./direct-videos.js','./enhancements.js','./v4-fix.js','./manifest.webmanifest','./icon.svg'];
