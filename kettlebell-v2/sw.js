const CACHE='kb-coach-v6-1';
const ASSETS=['./','./index.html','./styles.css','./program.js','./app.js','./direct-videos.js','./exercise-instructions.js','./enhancements.js','./v4-fix.js','./exercise-guide-ui.js','./manifest.webmanifest','./icon.svg'];
